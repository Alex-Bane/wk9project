...
def stats():
    ...
    wis_stat = stats[4]
    cha_stat = stats[5]
    strength = "1Strength: ", str_stat
    dexterity = "1Dexterity: ", dex_stat
    constitution = "1Constitution: ", con_stat
    inteligence = "1Inteligence: ", int_stat
    wisdom = "1Wisdom: ", wis_stat
    charisma = "1Charisma: ", cha_stat
